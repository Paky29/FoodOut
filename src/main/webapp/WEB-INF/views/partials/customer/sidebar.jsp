<aside class="sidebar">
    <nav class="menu grid-y align-center">
        ...
        <a href="/FoodOut/utente/saldo?function=0"> Gestione saldo</a>
        <a href="/FoodOut/utente/ristoranti-pref"> Ristoranti preferiti</a>
        <a href="/FoodOut/utente/storico">Cronologia ordini </a>
        <a href="/FoodOut/utente/utente-attesa"> Ordini in attesa</a>
