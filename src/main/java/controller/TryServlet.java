...
public class TryServlet extends HttpServlet {
    public void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            OrdineItem oi21=new OrdineItem();
            oi1.setOff(p1);
            oi1.setQuantita(2);
            OrdineItem oi22=new OrdineItem();
            oi2.setOff(p2);
            oi2.setQuantita(1);
            OrdineItem oi23=new OrdineItem();
            oi3.setOff(m1);
            oi3.setQuantita(3);
            OrdineItem oi24=new OrdineItem();
            oi4.setOff(m2);
            oi4.setQuantita(1);
            o.getOrdineItems().add(oi21);
            o.getOrdineItems().add(oi22);
            o.getOrdineItems().add(oi23);
